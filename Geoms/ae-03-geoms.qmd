...
# Basic bar chart 
ggplot(tompkins_beds, aes(x = beds)) +
  geom_bar() +
  labs(
    title = "Distribution of Bedrooms in Tompkins County Home Sales",
...
# Step 1: Stacked bar chart

ggplot(tompkins_beds, aes(x = beds, fill = decade_built_cat)) +
  geom_bar() +
  labs(
    title = "Number of Bedrooms by Decade Built (Stacked)",
    x = "Number of Bedrooms",
    y = "Count of Houses",
    fill = "Decade Built"
  )
...
# Step 2: Dodged bar chart

ggplot(tompkins_beds, aes(x = beds, fill = decade_built_cat)) +
  geom_bar(position = "dodge") +
  labs(
    title = "Number of Bedrooms by Decade Built (Dodged)",
    x = "Number of Bedrooms",
    y = "Count of Houses",
    fill = "Decade Built"
  )
...
# Step 3: Relative frequency bar chart

ggplot(tompkins_beds, aes(x = beds, fill = decade_built_cat)) +
  geom_bar(position = "fill") +
  labs(
    title = "Proportion of Bedrooms by Decade Built",
    x = "Number of Bedrooms",
    y = "Proportion",
    fill = "Decade Built"
  )
...
# Bar chart
ggplot(mean_price_decade, aes(x = decade_built_cat, y = mean_price)) +
  geom_col() +
  labs(
    title = "Average House Price by Decade Built",
    x = "Decade Built",
    y = "Mean Price ($)"
  ) +
...
# Boxplot
ggplot(tompkins, aes(x = decade_built_cat, y = price)) +
  geom_boxplot() +
  labs(
    title = "Distribution of House Prices by Decade Built",
    x = "Decade Built",
    y = "Price ($)"
  ) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
ggplot(tompkins, aes(x = decade_built_cat, y = price)) +
  geom_violin() +
  labs(
    title = "Price Distribution Density by Decade Built",
    x = "Decade Built",
    y = "Price ($)"
  ) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
ggplot(tompkins, aes(x = decade_built_cat, y = price)) +
  ...
  labs(
    title = "Individual House Prices by Decade Built",
    x = "Decade Built",
    y = "Price ($)"
  ) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
